...
Crafty.extend({
	...
	*/
	keyboardDispatch: function (e) {
		// [chalin
		// console.log('kD: ' + e.type + ' ' + e.which + ' ' + e.keyIdentifier + ', detail=' + e.detail
...
Crafty.bind("Load", function () {
	...
	if(true) {
		...
		Crafty.addEvent(this, $('#main'), "keydown", Crafty.keyboardDispatch);
		Crafty.addEvent(this, $('#main'), "keyup", Crafty.keyboardDispatch);
	}
	//chalin]
